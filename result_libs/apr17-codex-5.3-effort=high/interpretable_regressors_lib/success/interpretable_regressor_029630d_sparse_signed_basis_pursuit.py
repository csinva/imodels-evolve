...
SparseSignedBasisPursuitRegressor.__module__ = "interpretable_regressor"

# Update the model shorthand name and description below to reflect the class above and any changes you make to it.
# The shorthand name should be unique across all experiments (it is used to identify rows in the results CSV files)
# The description should briefly summarize what this experiment tried.
model_shorthand_name = "SparseSignedBasisPursuit_v1"
model_description = "Forward-selected sparse signed basis (linear/hinge/square/interaction) with ridge refit and light coefficient rounding"
model_defs = [(model_shorthand_name, SparseSignedBasisPursuitRegressor())]
