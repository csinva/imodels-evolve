...
model_shorthand_name = "HybridGAM_v30"
model_description = "HybridGAM: RF 150/d8 shrunk by 0.35 (target gap between v15 and v17)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=150, residual_depth=8, residual_type="rf", residual_shrinkage=0.35))]
