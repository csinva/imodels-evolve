...
model_shorthand_name = "HybridGAM_v5"
model_description = "SmartAdditiveGAM display + hidden 50-tree RandomForest depth-5 residual"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=50, residual_depth=5, residual_type="rf"))]
