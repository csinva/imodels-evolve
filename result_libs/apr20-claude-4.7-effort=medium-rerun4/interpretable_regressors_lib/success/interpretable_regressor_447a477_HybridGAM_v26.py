...
model_shorthand_name = "HybridGAM_v26"
model_description = "HybridGAM: RF 250/d10 shrunk by 0.15 (between v18 and v19)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=250, residual_depth=10, residual_type="rf", residual_shrinkage=0.15))]
