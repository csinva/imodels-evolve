...
model_shorthand_name = "HybridGAM_v15"
model_description = "HybridGAM: RF 100/d8 residual shrunk by 0.5 (deep trees but half-weighted)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=100, residual_depth=8, residual_type="rf", residual_shrinkage=0.5))]
