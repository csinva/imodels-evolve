...
model_shorthand_name = "HybridGAM_v27"
model_description = "HybridGAM: RF 180/d10 shrunk by 0.25 (between v17 and v18)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=180, residual_depth=10, residual_type="rf", residual_shrinkage=0.25))]
