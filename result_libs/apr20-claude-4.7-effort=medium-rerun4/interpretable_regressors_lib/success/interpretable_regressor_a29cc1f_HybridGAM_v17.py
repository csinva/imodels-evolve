...
model_shorthand_name = "HybridGAM_v17"
model_description = "HybridGAM: RF 150/d8 residual shrunk by 0.3 (push toward GAM-dominant predictions for cleaner interp)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=150, residual_depth=8, residual_type="rf", residual_shrinkage=0.3))]
