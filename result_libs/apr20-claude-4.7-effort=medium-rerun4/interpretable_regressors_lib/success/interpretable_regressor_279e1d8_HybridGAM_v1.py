...
model_shorthand_name = "HybridGAM_v1"
model_description = "SmartAdditiveGAM display + hidden 30-tree depth-2 residual GBM (lr=0.05)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=30, residual_depth=2, residual_lr=0.05))]
