...
model_shorthand_name = "HybridGAM_v18"
model_description = "HybridGAM: RF 200/d10 residual shrunk by 0.2 (very GAM-dominant with big hidden RF)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=200, residual_depth=10, residual_type="rf", residual_shrinkage=0.2))]
