...
model_shorthand_name = "HybridGAM_v19"
model_description = "HybridGAM: RF 300/d10 residual shrunk by 0.1 (ultra GAM-dominant, minuscule residual correction)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=300, residual_depth=10, residual_type="rf", residual_shrinkage=0.1))]
