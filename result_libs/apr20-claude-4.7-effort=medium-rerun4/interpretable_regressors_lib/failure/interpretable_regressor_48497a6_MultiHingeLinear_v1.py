...
model_shorthand_name = "MultiHingeLinear_v1"
model_description = "LassoCV on [x_j, max(0,x_j-t_jk)] with knots at 0.25/0.50/0.75 quantiles; clean hinge-linear equation"
model_defs = [(model_shorthand_name, MultiHingeLinear(quantiles=(0.25, 0.5, 0.75), cv=3))]
