...
model_shorthand_name = "OLSPlusTinyGBM_v1"
model_description = "OLS base + 30-tree max_depth=2 GBM on residuals"
model_defs = [(model_shorthand_name, OLSPlusTinyGBM(n_estimators=30, max_depth=2, learning_rate=0.1))]
