...
model_shorthand_name = "SmartAdditiveGAM_v8"
model_description = "Boosted-stump GAM (200 rds, R^2>0.70), max 4 thresholds/feature (simpler shape fns)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=200, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.70, n_smooth_passes=3, max_thresholds_per_feature=4))]
