...
model_shorthand_name = "HybridGAM_v12"
model_description = "SmartAdditiveGAM + hidden 100-tree depth=3 GBM residual (lr=0.05)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=100, residual_depth=3, residual_lr=0.05, residual_type="gbm", residual_shrinkage=1.0))]
