...
model_shorthand_name = "OLSPlusBestHinge_v1"
model_description = "OLS + per-feature single hinge at best quantile threshold, joint refit"
model_defs = [(model_shorthand_name, OLSPlusBestHingePerFeature(n_thresholds=9))]
