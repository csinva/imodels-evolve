...
model_shorthand_name = "RidgePlusShapes_v1"
model_description = "RidgeCV linear base + boosted-stump shape corrections on residuals; high-R^2 shapes absorbed into linear coefs"
model_defs = [(model_shorthand_name, RidgePlusShapes(n_rounds=150, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.70))]
