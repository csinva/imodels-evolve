...
model_shorthand_name = "StagewiseGAM_v1"
model_description = "Stagewise: GAM1 (200 rds) + GAM2 (100 rds on residuals); merged into one GAM (predict==display)"
model_defs = [(model_shorthand_name, StagewiseGAM(n_rounds_1=200, n_rounds_2=100))]
