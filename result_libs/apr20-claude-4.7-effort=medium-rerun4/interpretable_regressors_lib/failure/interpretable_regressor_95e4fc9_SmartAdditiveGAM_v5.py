...
model_shorthand_name = "SmartAdditiveGAM_v5"
model_description = "Boosted-stump GAM, 100 rounds, R^2>0.60 for linear (more features as linear coefs)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=100, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.60))]
