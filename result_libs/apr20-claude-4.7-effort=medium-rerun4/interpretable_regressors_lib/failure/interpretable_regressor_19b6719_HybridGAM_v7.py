...
model_shorthand_name = "HybridGAM_v7"
model_description = "SmartAdditiveGAM display + hidden 75-tree RandomForest depth-4 residual"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=75, residual_depth=4, residual_type="rf"))]
