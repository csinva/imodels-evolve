...
model_shorthand_name = "InteractionGAM_v1"
model_description = "SmartAdditiveGAM + single best x_i*x_j bilinear interaction term (selected from top-10 features)"
model_defs = [(model_shorthand_name, InteractionGAM(top_k_features=10))]
