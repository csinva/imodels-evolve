...
model_shorthand_name = "HybridGAM_v14"
model_description = "HybridGAM v5 variant: RF 50/d5 residual with max_features=sqrt (more diverse trees)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=50, residual_depth=5, residual_type="rf", residual_shrinkage=1.0))]
