...
model_shorthand_name = "HybridGAM_v3"
model_description = "SmartAdditiveGAM display + hidden 100-tree depth-3 residual GBM (lr=0.05)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=100, residual_depth=3, residual_lr=0.05))]
