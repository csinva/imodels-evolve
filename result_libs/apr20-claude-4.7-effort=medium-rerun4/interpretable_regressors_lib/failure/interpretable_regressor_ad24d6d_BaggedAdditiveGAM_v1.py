...
model_shorthand_name = "BaggedAdditiveGAM_v1"
model_description = "Bagged 3-GAM ensemble (subsample=0.9); display uses consensus GAM fit on full data"
model_defs = [(model_shorthand_name, BaggedAdditiveGAM(n_bags=3))]
