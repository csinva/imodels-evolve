...
class SmartAdditiveGAM(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=200, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.70, n_smooth_passes=3):
        self.n_rounds = n_rounds
        self.learning_rate = learning_rate
        self.min_samples_leaf = min_samples_leaf
        self.r2_linear_thresh = r2_linear_thresh
...
model_shorthand_name = "SmartAdditiveGAM_v7"
model_description = "Boosted-stump GAM, 200 rounds, 8 smoothing passes (more-linear shape fns → more features displayed as linear)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=200, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.70, n_smooth_passes=8))]
