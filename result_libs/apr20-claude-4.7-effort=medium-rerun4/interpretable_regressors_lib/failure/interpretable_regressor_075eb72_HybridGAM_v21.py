...
model_shorthand_name = "HybridGAM_v21"
model_description = "HybridGAM: RF 75/d6 residual shrunk by 0.7 (intermediate between v5 and v15)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=75, residual_depth=6, residual_type="rf", residual_shrinkage=0.7))]
