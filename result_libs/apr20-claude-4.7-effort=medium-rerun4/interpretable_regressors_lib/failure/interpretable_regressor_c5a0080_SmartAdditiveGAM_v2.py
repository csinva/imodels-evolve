...
model_shorthand_name = "SmartAdditiveGAM_v2"
model_description = "Boosted-stump GAM, 400 rounds, min_leaf=10, smoothed shape fns, adaptive linear/piecewise display (R^2>0.70)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=400, learning_rate=0.05, min_samples_leaf=10, r2_linear_thresh=0.70))]
