...
model_shorthand_name = "SmartAdditiveGAM_v3"
model_description = "Boosted-stump GAM (piecewise predict) + display-only linear approx (R^2>0.85) to keep readable formula"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=200, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.85))]
