...
model_shorthand_name = "HybridGAM_v16"
model_description = "HybridGAM: RF 100/d8 residual shrunk by 0.7 (deep trees, moderate weighting)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=100, residual_depth=8, residual_type="rf", residual_shrinkage=0.7))]
