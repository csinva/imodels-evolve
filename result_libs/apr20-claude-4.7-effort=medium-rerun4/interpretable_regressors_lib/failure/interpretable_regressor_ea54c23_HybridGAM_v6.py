...
model_shorthand_name = "HybridGAM_v6"
model_description = "SmartAdditiveGAM display + hidden 100-tree RandomForest depth-8 residual"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=100, residual_depth=8, residual_type="rf"))]
