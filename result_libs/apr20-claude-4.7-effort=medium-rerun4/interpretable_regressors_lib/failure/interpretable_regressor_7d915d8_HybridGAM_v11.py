...
model_shorthand_name = "HybridGAM_v11"
model_description = "SmartAdditiveGAM + hidden single DecisionTree depth=8 residual (minimal hidden complexity)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=1, residual_depth=8, residual_type="dt", residual_shrinkage=1.0))]
