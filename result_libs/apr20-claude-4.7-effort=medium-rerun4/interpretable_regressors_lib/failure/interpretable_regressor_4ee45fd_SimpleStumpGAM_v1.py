...
model_shorthand_name = "SimpleStumpGAM_v1"
model_description = "Single best-stump per feature + linear; ridge calibration; clean if-then display"
model_defs = [(model_shorthand_name, SimpleStumpGAM(min_samples_leaf=5, alpha=1.0, include_linear=True))]
