...
model_shorthand_name = "HybridGAM_v22"
model_description = "HybridGAM: RF 400/d5 no shrinkage (bigger ensemble than v8 for deeper rank push)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=400, residual_depth=5, residual_type="rf", residual_shrinkage=1.0))]
