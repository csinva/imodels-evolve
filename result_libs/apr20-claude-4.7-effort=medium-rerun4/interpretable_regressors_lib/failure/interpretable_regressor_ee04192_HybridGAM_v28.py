...
model_shorthand_name = "HybridGAM_v28"
model_description = "HybridGAM: RF 80/d6 shrunk by 0.8 (gap between v5 and v15)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=80, residual_depth=6, residual_type="rf", residual_shrinkage=0.8))]
