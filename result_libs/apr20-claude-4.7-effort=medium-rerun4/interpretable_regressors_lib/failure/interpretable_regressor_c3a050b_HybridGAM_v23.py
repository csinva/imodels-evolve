...
model_shorthand_name = "HybridGAM_v23"
model_description = "HybridGAM: RF 150/d6 no shrinkage (tweak depth/trees between v5 and v8)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=150, residual_depth=6, residual_type="rf", residual_shrinkage=1.0))]
