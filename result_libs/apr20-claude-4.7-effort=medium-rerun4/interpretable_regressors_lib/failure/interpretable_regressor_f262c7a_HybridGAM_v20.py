...
model_shorthand_name = "HybridGAM_v20"
model_description = "HybridGAM: GBM 200/d4 lr=0.05 residual shrunk by 0.6 (GBM may be more precise than RF)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=200, residual_depth=4, residual_type="gbm", residual_lr=0.05, residual_shrinkage=0.6))]
