...
model_shorthand_name = "SmartAdditiveGAM_v6"
model_description = "Boosted-stump GAM, 200 rounds, R^2>0.50 linear threshold (even more features as linear coefs)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=200, learning_rate=0.1, min_samples_leaf=5, r2_linear_thresh=0.50))]
