...
model_shorthand_name = "HybridGAM_v25"
model_description = "HybridGAM: RF 125/d8 shrunk by 0.4 (gap between v15 and v17)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=125, residual_depth=8, residual_type="rf", residual_shrinkage=0.4))]
