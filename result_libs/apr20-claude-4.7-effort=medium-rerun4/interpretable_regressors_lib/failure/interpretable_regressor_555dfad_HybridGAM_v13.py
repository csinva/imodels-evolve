...
model_shorthand_name = "HybridGAM_v13"
model_description = "SmartAdditiveGAM + hidden 30-tree RF depth=3 residual (smaller/conservative vs v5)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=30, residual_depth=3, residual_type="rf", residual_shrinkage=1.0))]
