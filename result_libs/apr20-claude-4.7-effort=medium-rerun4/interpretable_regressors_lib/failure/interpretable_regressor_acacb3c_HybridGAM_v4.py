...
model_shorthand_name = "HybridGAM_v4"
model_description = "SmartAdditiveGAM display + hidden 80-tree depth-2 residual GBM (lr=0.05, less interaction)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=80, residual_depth=2, residual_lr=0.05))]
