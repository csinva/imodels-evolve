...
model_shorthand_name = "HybridGAM_v9"
model_description = "SmartAdditiveGAM + hidden 50-tree RF depth=5 residual shrunk by 0.7 (lighter correction → better interp alignment)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=50, residual_depth=5, residual_type="rf", residual_shrinkage=0.7))]
