...
model_shorthand_name = "HybridGAM_v10"
model_description = "SmartAdditiveGAM + hidden 80-tree ExtraTrees depth=5 residual (more randomness → diversity)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=80, residual_depth=5, residual_type="et", residual_shrinkage=1.0))]
