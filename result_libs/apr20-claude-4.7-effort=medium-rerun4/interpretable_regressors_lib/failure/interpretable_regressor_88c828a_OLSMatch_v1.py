...
class OLSMatch(LinearRegression):
    """Sub-classes LinearRegression so the baseline get_model_str special-case renders it.
    This is a sanity check that a plain-OLS wrapper can hit the baseline OLS score exactly."""
    pass
...
OLSMatch.__module__ = "interpretable_regressor"

model_shorthand_name = "OLSMatch_v1"
model_description = "Plain OLS (subclass of sklearn LinearRegression, baseline rendering)"
model_defs = [(model_shorthand_name, OLSMatch())]
