...
model_shorthand_name = "SmartAdditiveGAM_v9"
model_description = "SmartAdditiveGAM 300 rounds, lr=0.08, min_leaf=3, R^2>0.70 (more capacity, smaller leaves)"
model_defs = [(model_shorthand_name, SmartAdditiveGAM(n_rounds=300, learning_rate=0.08, min_samples_leaf=3, r2_linear_thresh=0.70, n_smooth_passes=3))]
