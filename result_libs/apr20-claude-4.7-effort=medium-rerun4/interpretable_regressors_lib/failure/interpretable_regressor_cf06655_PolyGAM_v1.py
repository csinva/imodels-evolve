...
model_shorthand_name = "PolyGAM_v1"
model_description = "Cyclic per-feature polynomial GAM, degree 2, 4 rounds, ridge alpha=1"
model_defs = [(model_shorthand_name, PolyGAM(max_degree=2, n_rounds=4, ridge_alpha=1.0))]
