...
model_shorthand_name = "HybridGAM_v29"
model_description = "HybridGAM: RF 300/d15 no shrinkage (deeper trees, big ensemble — push rank extreme)"
model_defs = [(model_shorthand_name, HybridGAM(n_residual_trees=300, residual_depth=15, residual_type="rf", residual_shrinkage=1.0))]
