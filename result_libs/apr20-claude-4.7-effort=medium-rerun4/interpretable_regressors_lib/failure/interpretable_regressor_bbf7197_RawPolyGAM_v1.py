...
model_shorthand_name = "RawPolyGAM_v1"
model_description = "LassoCV on raw-space linear + squared features; clean polynomial equation display"
model_defs = [(model_shorthand_name, RawPolyGAM(include_sq=True, cv=3))]
