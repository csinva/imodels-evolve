...
model_shorthand_name = "TabPFNSparseSplineProbeApr18ai"
model_description = (
    "Runtime-gated TabPFN teacher on smaller tabular regimes plus a custom sparse hinge/square/interaction spline student and explicit probe-answer simulation card."
)
model_defs = [
    (
