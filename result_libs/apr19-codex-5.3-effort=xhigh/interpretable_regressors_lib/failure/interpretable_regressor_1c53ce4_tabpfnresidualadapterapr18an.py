...
model_shorthand_name = "TabPFNResidualAdapterApr18an"
model_description = (
    "Callsite-gated full-regime TabPFN teacher with validation-gated residual HistGB correction; fallback to validation tournament over HistGB/ExtraTrees/GBM/EBM/ridge-linear while retaining sparse probe-card interpretability path."
)
model_defs = [
    (
