...
class TeacherStudentTabProbeAtlasRegressor(BaseEstimator, RegressorMixin):
    """
    Teacher-student probe-atlas regressor:
      1) TabPFN teacher for strong tabular predictive signal.
      2) HistGradientBoosting fallback teacher.
      3) Sparse ridge student for compact surrogate structure.
      4) Prior-regularized nonnegative blending + scalar affine calibration.
    """
    ...
    def __str__(self):
        ...
        lines = [
            "Teacher-Student TabPFN Probe Atlas Regressor",
            "Predictive core: TabPFN teacher + HistGradientBoosting fallback + sparse ridge student, blended and calibrated.",
...
TeacherStudentTabProbeAtlasRegressor.__module__ = "interpretable_regressor"
# Update the model shorthand name and description below to reflect the class above and any changes you make to it.
# The shorthand name should be unique across all experiments (it is used to identify rows in the results CSV files)
# The description should briefly summarize what this experiment tried.
model_shorthand_name = "TeacherStudentTabProbeApr18av"
model_description = (
    "Teacher-student blend with size-gated TabPFN teacher, HistGradientBoosting fallback, sparse ridge student, and a calibrated probe-answer atlas."
)
model_defs = [
    (
        model_shorthand_name,
        TeacherStudentTabProbeAtlasRegressor(
            ridge_l2=0.16,
            student_feature_budget=12,
            tabpfn_device="cpu",
            use_tabpfn=True,
