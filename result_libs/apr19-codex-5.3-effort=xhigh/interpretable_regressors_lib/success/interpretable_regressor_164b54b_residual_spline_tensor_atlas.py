...
class ResidualSplineTensorAtlasRegressor(BaseEstimator, RegressorMixin):
    """
    ...
    def fit(self, X, y):
        ...
        init_intercept, init_coef = self._ridge_with_intercept(backbone_add, y, self.ridge_l2)
    ...
    def __str__(self):
        ...
        lines = [
            "Residual Spline Tensor Atlas Regressor",
...
ResidualSplineTensorAtlasRegressor.__module__ = "interpretable_regressor"

# Update the model shorthand name and description below to reflect the class above and any changes you make to it.
# The shorthand name should be unique across all experiments (it is used to identify rows in the results CSV files)
# The description should briefly summarize what this experiment tried.
model_shorthand_name = "ResidualSplineTensorAtlasApr18l"
model_description = (
    "Ridge backbone with screened additive hinge splines, residual-selected interactions, and a short residual stump stage plus a compact probe-answer simulation card."
)
model_defs = [
    (
        model_shorthand_name,
        ResidualSplineTensorAtlasRegressor(
            ridge_l2=0.55,
            spline_feature_budget=18,
            spline_quantiles=(0.08, 0.18, 0.32, 0.5, 0.68, 0.82, 0.92),
            interaction_screen=12,
