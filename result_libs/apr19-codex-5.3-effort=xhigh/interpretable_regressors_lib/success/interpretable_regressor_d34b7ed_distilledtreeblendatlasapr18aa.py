...
DistilledTreeBlendAtlasRegressor.__module__ = "interpretable_regressor"
# Update the model shorthand name and description below to reflect the class above and any changes you make to it.
# The shorthand name should be unique across all experiments (it is used to identify rows in the results CSV files)
# The description should briefly summarize what this experiment tried.
model_shorthand_name = "DistilledTreeBlendAtlasApr18aa"
model_description = (
    "Distilled ensemble with ridge student plus GBM/RF teachers, validation-calibrated nonnegative blending, and a probe-answer simulation atlas."
)
model_defs = [
    (
        ...
        DistilledTreeBlendAtlasRegressor(
            ...
            min_validation_samples=24,
            blend_l2=1e-4,
            min_component_weights=(0.12, 0.10, 0.08),
            gbm_estimators_base=110,
            gbm_estimators_scale=3.5,
            gbm_estimators_cap=190,
            gbm_learning_rate=0.05,
