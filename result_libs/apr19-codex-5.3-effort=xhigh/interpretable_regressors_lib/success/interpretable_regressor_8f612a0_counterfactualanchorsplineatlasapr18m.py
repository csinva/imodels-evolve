...
class CounterfactualAnchorSplineAtlasRegressor(BaseEstimator, RegressorMixin):
    """
    ...
    def fit(self, X, y):
        ...
        if n_features > 0:
            importance = (
                ...
                + 0.22 * _norm(spline_mass)
                + 0.14 * _norm(feature_gain)
    ...
    def __str__(self):
        ...
        lines = [
            "Counterfactual Anchor Spline Atlas Regressor",
...
CounterfactualAnchorSplineAtlasRegressor.__module__ = "interpretable_regressor"

# Update the model shorthand name and description below to reflect the class above and any changes you make to it.
# The shorthand name should be unique across all experiments (it is used to identify rows in the results CSV files)
# The description should briefly summarize what this experiment tried.
model_shorthand_name = "CounterfactualAnchorSplineAtlasApr18m"
model_description = (
    "Adaptive-L2 spline-atlas backbone with screened interactions and adaptive stump budget, plus explicit counterfactual answer anchors in the simulation card."
)
model_defs = [
    (
        model_shorthand_name,
        CounterfactualAnchorSplineAtlasRegressor(
            ridge_l2=0.55,
            ridge_scale_with_dim=0.32,
            spline_feature_budget=18,
            spline_quantiles=(0.08, 0.18, 0.32, 0.5, 0.68, 0.82, 0.92),
