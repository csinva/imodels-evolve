...
class HingeLinearRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_knots=2, max_terms=15, tree_depth=3, n_trees=3, lr=0.5):
    ...
    def fit(self, X, y):
        ...
        # Stage 2: Fit sklearn GBM on residuals for better optimization
...
if __name__ == "__main__":
    ...
    model_defs = [("HingeK2D3big", HingeLinearRegressor())]
    ...
    upsert_overall_results([{
        ...
        "status":                             "",
        "model_name":                         "HingeK2D3big",
        "description":                        "2-knot hinge-linear + GBM residual (200 trees depth 3 lr 0.05)",
    }], RESULTS_DIR)
