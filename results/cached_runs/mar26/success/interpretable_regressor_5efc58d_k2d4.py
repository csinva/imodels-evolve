...
class HingeLinearRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_knots=2, max_terms=15, tree_depth=4, n_trees=3, lr=0.5):
...
if __name__ == "__main__":
    ...
    model_defs = [("HingeK2D4", HingeLinearRegressor())]
    ...
    upsert_overall_results([{
        ...
        "status":                             "",
        "model_name":                         "HingeK2D4",
        "description":                        "2-knot hinge-linear + GBM residual (100 trees depth 4 lr 0.05)",
    }], RESULTS_DIR)
