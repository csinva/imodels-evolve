...
class HingeLinearRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_knots=4, max_terms=15, tree_depth=3, n_trees=2, lr=0.5):
...
if __name__ == "__main__":
    ...
    model_defs = [("HingeK4T2", HingeLinearRegressor())]
    ...
    upsert_overall_results([{
        ...
        "status":                             "",
        "model_name":                         "HingeK4T2",
        "description":                        "4 knots + 2 boosted trees (more linear expressiveness)",
    }], RESULTS_DIR)
