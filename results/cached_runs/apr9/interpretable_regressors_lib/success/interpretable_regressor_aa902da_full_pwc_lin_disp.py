...
model_shorthand_name = "FullPWC_LinDisp"
model_description = "Full piecewise-constant predict + Ridge-style display for linear features — best rank with decent interp"
