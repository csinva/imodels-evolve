...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        # No early stopping — use all data directly
        X_tr, y_tr = X, y
...
model_shorthand_name = "SmoothGAM_noES"
model_description = "SmoothAdditiveGAM without early stopping (all data, no validation split)"
