...
model_shorthand_name = "SmartAdditive_v1"
model_description = "Greedy additive stumps with adaptive display: linear for linear features, piecewise for nonlinear"
