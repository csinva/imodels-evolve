...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        if resid_frac > 0.20:  # Very conservative
            ...
            self.tiny_gbm_ = _RFR(n_estimators=100, max_depth=3, random_state=42)
...
model_shorthand_name = "SmoothGAM_RF100"
model_description = "SmoothGAM + RF 100 trees depth-3 on residuals"
