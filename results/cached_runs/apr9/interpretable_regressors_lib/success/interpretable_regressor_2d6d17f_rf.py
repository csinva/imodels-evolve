...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        if resid_frac > 0.20:  # Very conservative
            ...
            self.tiny_gbm_ = _RFR(n_estimators=50, max_depth=3, random_state=42)
...
model_shorthand_name = "SmoothGAM_RF"
model_description = "SmoothAdditiveGAM + RandomForest on residuals"
