...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def predict(self, X):
        ...
        for j, (thresholds, intervals) in self.shape_functions_.items():
            ...
            if r2 > 0.90 and total_importance > 1e-10 and self.feature_importances_[j] / total_importance >= 0.01:
...
model_shorthand_name = "SmoothGAM_hybrid"
model_description = "SmoothAdditiveGAM + early stopping + hybrid predict (linear for R2>0.90, piecewise for rest)"
