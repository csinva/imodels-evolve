...
class SklearnStumpGAM(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_estimators=300, learning_rate=0.1, min_samples_leaf=5,
                 subsample=0.8):
...
model_shorthand_name = "SkStumpGAM_stoch"
model_description = "sklearn GBM depth-1 (300 est, subsample=0.8) with adaptive display"
