...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __str__(self):
        ...
        for j in self.shape_functions_:
            if self.feature_importances_[j] / total_importance < 0.03:
                continue
...
model_shorthand_name = "SmoothGAM_3pct"
model_description = "SmoothAdditiveGAM with 3% importance threshold (more features excluded)"
