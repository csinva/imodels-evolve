...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=250, learning_rate=0.08, min_samples_leaf=5):
...
model_shorthand_name = "SmoothGAM_250_08"
model_description = "SmoothAdditiveGAM with 250 rounds, lr=0.08"
