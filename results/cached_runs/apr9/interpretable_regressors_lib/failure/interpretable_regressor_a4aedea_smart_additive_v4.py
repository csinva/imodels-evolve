...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=400, learning_rate=0.08, min_samples_leaf=5):
...
model_shorthand_name = "SmartAdditive_v4"
model_description = "SmartAdditive with 400 rounds, lr=0.08, R2=0.85 for more boosting"
