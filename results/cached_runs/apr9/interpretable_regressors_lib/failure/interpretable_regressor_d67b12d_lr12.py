...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=200, learning_rate=0.12, min_samples_leaf=5):
...
model_shorthand_name = "SmoothGAM_lr12"
model_description = "SmoothAdditiveGAM with lr=0.12 (slightly higher)"
