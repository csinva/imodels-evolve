...
class HingeEBMRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_knots=2, max_input_features=15,
                 ebm_outer_bags=2, ebm_max_rounds=200):
...
model_shorthand_name = "HingeEBM_200r"
model_description = "HingeEBM with 200 EBM rounds (less aggressive EBM, less display/predict mismatch)"
