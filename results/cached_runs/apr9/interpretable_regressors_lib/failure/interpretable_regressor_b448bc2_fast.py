...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=150, learning_rate=0.15, min_samples_leaf=5):
...
model_shorthand_name = "SmoothGAM_fast"
model_description = "SmoothAdditiveGAM R2=0.70, 150 rounds, lr=0.15 (faster convergence)"
