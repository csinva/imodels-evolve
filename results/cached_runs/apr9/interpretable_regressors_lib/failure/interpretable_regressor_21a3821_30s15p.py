...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        if resid_frac > 0.15:  # Slightly less conservative
            self.tiny_gbm_ = _GBR(n_estimators=30, max_depth=1, learning_rate=0.05,
                                   random_state=42)
...
model_shorthand_name = "SmoothGAM_30s15p"
model_description = "SmoothAdditiveGAM + 30 stumps GBM when >15% residual var"
