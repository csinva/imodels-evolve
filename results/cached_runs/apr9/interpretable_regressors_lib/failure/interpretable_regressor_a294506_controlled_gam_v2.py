...
class ControlledGAMRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_outer_rounds=100, learning_rate=0.15,
                 min_samples_leaf=5, max_splits_per_feature=8):
...
model_shorthand_name = "ControlledGAM_v2"
model_description = "Cyclic additive stumps with max 8 splits per feature (9 intervals), 100 outer rounds"
