...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=500, learning_rate=0.05, min_samples_leaf=5):
...
model_shorthand_name = "SmartAddGAM_500r"
model_description = "SmartAdditiveGAM R2=0.90, 500 rounds, lr=0.05 (more fine-grained boosting)"
