...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __str__(self):
        ...
        # Add verification example: prediction at origin
        if linear_features:
            lines.append("")
            lines.append(f"Verification: for all features = 0, predicted y = {combined_intercept:.4f}")
...
model_shorthand_name = "SmoothGAM_verify"
model_description = "SmoothAdditiveGAM + verification example at origin in display"
