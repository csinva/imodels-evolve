...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=200, learning_rate=0.1, min_samples_leaf=5, leaf_reg=1.0):
        self.n_rounds = n_rounds
        self.learning_rate = learning_rate
        self.min_samples_leaf = min_samples_leaf
        self.leaf_reg = leaf_reg  # L2 regularization on leaf values
        ...
        for round_idx in range(self.n_rounds):
            ...
            for j in range(n_features):
                ...
                if reduction[best_idx] > best_reduction:
                    ...
                    # L2-regularized leaf values (like XGBoost)
                    left_mean = left_sum[best_idx] / (left_count[best_idx] + self.leaf_reg)
                    right_mean = right_sum[best_idx] / (right_count[best_idx] + self.leaf_reg)
...
model_shorthand_name = "SmoothGAM_leafReg"
model_description = "SmoothAdditiveGAM with L2-regularized leaf values (lambda=1.0)"
