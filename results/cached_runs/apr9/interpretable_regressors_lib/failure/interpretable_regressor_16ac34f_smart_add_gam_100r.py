...
class SmartAdditiveRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, n_rounds=100, learning_rate=0.2, min_samples_leaf=5):
...
model_shorthand_name = "SmartAddGAM_100r"
model_description = "SmartAdditiveGAM with 100 rounds, lr=0.2 (fewer, larger steps for simpler shape functions)"
