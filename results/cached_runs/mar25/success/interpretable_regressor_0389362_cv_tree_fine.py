...
class InterpretableRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        # Fine-grained CV over max_leaf_nodes
        options = list(range(4, 35))
        best_score = -np.inf
...
if __name__ == "__main__":
    ...
    upsert_overall_results([{
        ...
        "description":                        "Single CV-tuned tree with fine-grained max_leaf_nodes search (4-34)",
    }], RESULTS_DIR)
